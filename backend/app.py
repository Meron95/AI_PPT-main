...
def convert():
    try:
        ...
        # Validate the generated code for unsupported attributes or methods
        unsupported_attributes = ['DASH']
        for attr in unsupported_attributes:
            if f'MSO_AUTO_SHAPE_TYPE.{attr}' in ppt_code:
                return jsonify({"error": f"Generated code uses unsupported attribute: MSO_AUTO_SHAPE_TYPE.{attr}"}), 400
